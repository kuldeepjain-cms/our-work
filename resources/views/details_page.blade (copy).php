...
<div class="container">
<div style="width: 100%;    margin: 25px 0;    display: inline-block;">
...
<div class="cbp-slider">
    <ul class="cbp-slider-wrap">
        <li class="cbp-slider-item">
            <a href="{{ URL::asset('template/frontend/images/'.$portfolio[0]->image) }}" class="cbp-lightbox">
                <img src="{{ URL::asset('template/frontend/images/'.$portfolio[0]->image) }}" alt="">
            </a>
        </li>
...
<div class="cbp-l-project-container">
    <div class="cbp-l-project-desc">
        <div class="cbp-l-project-desc-text">{{ $portfolio[0]->content }}</div>

    </div>
    <div class="cbp-l-project-details">
        <ul class="cbp-l-project-details-list">
              <li><strong>Technology</strong><?php echo str_replace(",", " , ", $portfolio[0]->tags); ?></li>
              <li><strong>Categories</strong>{{ $portfolio[0]->technology }}</li>
        </ul>
