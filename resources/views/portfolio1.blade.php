...
<!--div class="container" style="max-width: 1200px; width: 97%; margin: 55px auto; min-height: 1000px;">
  ...
  <!-- http://www.weblicioussolutions.com/demo/ -->
          ...
          <ul class="cbp-l-filters-dropdownList">
              <?php if($technology == 'all'){ ?>
                ...
                <?php foreach ($categories as $category): ?>
                  <li>
                    <div data-filter=".<?php echo strtolower(str_replace(' ', '', $category->category_name)); ?>" class="cbp-filter-item" id="cat">
                        {{$category->category_name}} <span class="cbp-filter-counter"></span>
                    </div>
                  </li>
                <?php endforeach; ?>
              <?php }else{ ?>
                <li>
                  <div data-filter=".<?php echo strtolower(str_replace(' ', '', $technology)); ?>" class="cbp-filter-item-active cbp-filter-item" id="cat">
                      {{$technology}} <span class="cbp-filter-counter"></span>
                  </div>
                </li>
              <?php } ?>
          </ul>
...
<div class="wrapper container wrap-container">
  <div id="filters-container" class="cbp-l-filters-button cbp-loading">
    <!--div class="cbp-l-filters-buttonWrap"-->
      ...
      <?php foreach ($technologies as $technology): ?>
        <div data-filter=".<?php echo strtolower(str_replace(' ', '', $technology->technology_name)); ?>" class="cbp-filter-item" id="cat">
            {{$technology->technology_name}} <div class="cbp-filter-counter"></div>
        </div>
      <?php endforeach; ?>
  ...
  <div id="grid-container" class="cbp-l-grid-gallery cbp cbp-loading cbp-caption-overlayBottomPush">
    <div class="cbp-wrapper">
      ...
      <?php endforeach; } else { ?>
        <div> No portfolios found for selected technology</div>
      <?php } ?>
    </div>
  </div>    
</div>
